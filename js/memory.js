...
const themeCards = {
    superheroes: ['🦸‍♂️', '🦸‍♀️', '🦹‍♂️', '⚡', '🔥', '🛡️', '⭐', '💥'],
    animals: [
        'assets/photos/animals/hond.jpg',
        'assets/photos/animals/kat.jpg',
        'assets/photos/animals/vos.jpg',
        'assets/photos/animals/panda.jpg',
        'assets/photos/animals/leeuw.jpg',
        'assets/photos/animals/aap.jpg',
        'assets/photos/animals/kikker.jpg',
        'assets/photos/animals/olifant.jpg'
    ],
    cars: ['🚗', '🚕', '🚙', '🚌', '🏎️', '🚓', '🚒', '🚚'],
    fruit: ['🍎', '🍌', '🍓', '🍇', '🍊', '🍉', '🍑', '🍍'],
    ocean: ['🐠', '🐙', '🐳', '🦀', '🐬', '🐡', '🦈', '🐚']
...
// Nederlandse namen per kaart (emoji of foto), voor schermlezers[cite: 4]
const cardLabels = {
    '🦸‍♂️': 'superheld', '🦸‍♀️': 'superheldin', '🦹‍♂️': 'schurk', '⚡': 'bliksem',
    '🔥': 'vuur', '🛡️': 'schild', '⭐': 'ster', '💥': 'explosie',
    'assets/photos/animals/hond.jpg': 'hond',
    'assets/photos/animals/kat.jpg': 'kat',
    'assets/photos/animals/vos.jpg': 'vos',
    'assets/photos/animals/panda.jpg': 'panda',
    'assets/photos/animals/leeuw.jpg': 'leeuw',
    'assets/photos/animals/aap.jpg': 'aap',
    'assets/photos/animals/kikker.jpg': 'kikker',
    'assets/photos/animals/olifant.jpg': 'olifant',
    '🚗': 'auto', '🚕': 'taxi', '🚙': 'suv', '🚌': 'bus',
...
// Een kaartwaarde kan een emoji zijn of het pad naar een echte foto[cite: 4]
function isPhoto(value) {
    return /\.(jpe?g|png|webp)$/i.test(value);
}

function showCardFace(card, value) {
    if (isPhoto(value)) {
...
function startMemoryGame(selectedTheme = 'animals', totalCards = 16) {
    ...
    let availableCards = themeCards[selectedTheme] || themeCards.animals;

    // 1. Unieke kaartwaarden selecteren[cite: 4]
    shuffleArray(availableCards);
    const selectedCards = availableCards.slice(0, totalPairs);
...
function flipCard() {
    ...
    showCardFace(selectedCard, selectedCard.dataset.value);
    ...
    cardsChosen.push(selectedCard.dataset.value);
...
function checkForMatch() {
    ...
    if (optionOneId === optionTwoId) {
        ...
        hideCardFace(cards[optionTwoId]);
